...
TEST(tokenizerTest, leftParenthesis1) {
  tokenizer test("(");
  queue<Token> element = test.getList();
  EXPECT_TRUE(!element.empty());
  Token verificator = element.front();
  EXPECT_TRUE(verificator.isParenthesisLeft());
  EXPECT_EQ(verificator.getValue(), "(");
}

TEST(tokenizerTest, rightParenthesis1) {
  tokenizer test(")");
  queue<Token> element = test.getList();
  EXPECT_TRUE(!element.empty());
  Token verificator = element.front();
  EXPECT_TRUE(verificator.isParenthesisRight());
  EXPECT_EQ(verificator.getValue(), ")");
}

TEST(tokenizerTest, leftParenthesis2) {
  tokenizer test("[");
  queue<Token> element = test.getList();
  EXPECT_TRUE(!element.empty());
  Token verificator = element.front();
...
TEST(tokenizerTest, rightParenthesis2) {
  tokenizer test("]");
  queue<Token> element = test.getList();
  EXPECT_TRUE(!element.empty());
  Token verificator = element.front();
...
TEST(tokenizerTest, leftParenthesis3) {
  tokenizer test("{");
  queue<Token> element = test.getList();
  EXPECT_TRUE(!element.empty());
  Token verificator = element.front();
...
TEST(tokenizerTest, rightParenthesis3) {
  tokenizer test("}");
  queue<Token> element = test.getList();
  EXPECT_TRUE(!element.empty());
  Token verificator = element.front();
